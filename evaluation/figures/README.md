...
| `make_error_distribution.py` | `19_error_distribution.png`, `results/error_distribution_summary.json` | `results/_review_cache_<run>.npz` for both runs, summary.json, metrics_detr.json, test parquets |
